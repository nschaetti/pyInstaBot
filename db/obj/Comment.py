...
class Comment(Base):
    ...
    comment_username = Column(Unicode(2000), nullable=False)
    comment_media = Column(Unicode(5000), nullable=True)
    comment_date = Column(DateTime, nullable=True, default=None)
